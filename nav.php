            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <?php if ($_SESSION['user_type'] == 'admin') { echo '<li class="nav-item">
                  <!-- Link--><a class="nav-link" href="detail.php">Admin Board</a>
                </li>'; } ?>
              ...
              <ul class="navbar-nav ms-auto">               
                <li class="nav-item"><a class="nav-link" href="cart.php"> <img src="icons/cart-flatbed.svg" style="height: 10px;" alt=""> Cart<small class="text-gray fw-normal count">(<?php echo $_SESSION['count']; ?>)</small></a></li>
               <?php 
               if ( $_SESSION['user_type'] === 'guest' ) {
                echo ' <li class="nav-item"><a class="nav-link" href="#!"> <img src="icons/right-from-bracket.svg" style="height: 10px;" alt=""> Login</a></li>
                ';
               } else {
                echo ' <form method = "post" action = ""> <button class="nav-item btn btn-secondary p-0 m-0 bg-transparent border-0" type="submit" name="logout"><a class="nav-link" > <img src="icons/right-from-bracket.svg" style="height: 10px;" alt=""> Logout</a></button>
                </form>';
               }
              ?>
                </ul>

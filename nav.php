...
?>
<header class="header bg-white w-100" style="position: sticky; top: 0; left: 0; z-index: 30;">
          ...
          <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="index.php"><span class="fw-bold text-uppercase text-dark">Sella</span></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item">
                  <!-- Link--><a class="nav-link" href="profile.php"> <i class="fa fa-shop d-md-none"></i> Profile</a>
                </li>
                <!-- <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="pagesDropdown" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fa fa-p d-md-none"></i> My Account</a>
                 ...
                 <?php 
                if ($_SESSION['user_type'] == 'admin') { echo '<li class="nav-item">
              ...
              <ul class="navbar-nav ms-auto">               
                ...
                <li class="nav-item">
                <?php 
                 if ($_SESSION['user_type'] == 'standard') { echo '<a class="nav-link" href="help.php"> <i class="fa fa-support d-md-none"></i> Help</a>'; }
                ?>
                </li>
                <form method = "post" action = ""> <button class="nav-item btn btn-secondary p-0 m-0 bg-transparent border-0" type="submit" name="logout"><a class="nav-link" >                 <i class="fa fa-sign-out"></i>
                Logout</a></button>
                </form>

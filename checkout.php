...
<html>
              ...
              <form action="#" class="checkf">
                <div class="row gy-3">
                  <div class="col-lg-6">
                    ...
                    <input class="form-control form-control-lg" type="text" id="firstName" value="<?php echo $_SESSION['fname']; ?>">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="lastName">Last name </label>
                    <input class="form-control form-control-lg" type="text" id="lastName" value="<?php echo $_SESSION['lname']; ?>">
                  </div>
                  <div class="col-lg-6">
                    <label class="form-label text-sm text-uppercase" for="email">Email address </label>
                    <input class="form-control form-control-lg" type="email" id="email" value="<?php echo $_SESSION['email']; ?>">
                  </div>
                  <div class="col-lg-6">
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                      ...
                      if ($row > 0) {
                        ...
                        //get products information 
                          ...
                          $rows = mysqli_affected_rows($connection);
                                ...
                                echo '
                                <li class="d-flex align-items-center justify-content-between"><strong class="small fw-bold">'.$cart_result['product_name'].'</strong><span class="text-muted small">'.dollar.$cart_result['product_new_price'].'</span></li>
                    ...
                    <li class="d-flex align-items-center justify-content-between"><strong class="text-uppercase small fw-bold">Total</strong><span><?php echo dollar.$_SESSION['total']; ?></span></li>
                  </ul>
                </div>
              </div>
            </div>
    ...
    <!-- <div class="sign-guest gform" id="ffr">
      ...
      <div class="form-label">  
        ...
        <div class="form-label">  
          ...
          <input type="email" name="email" id="email0">
      </div>
      ...
      <button class="btn btn-success p-2 rounded mb-1 log log1">Login</button>
      </form>
    </div>


    <div class="login-guest lform d-none" id="ffr">
      <form action="" method="POST">
        <div class="form-label">  
          <label for="">Email</label>
          <input type="email" name="lemail" id="lemail0">
      </div>
  ...
  // off = () => {
  //   frog.setAttribute('class' , 'd-none');
  // }

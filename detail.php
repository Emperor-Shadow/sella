...
if (!$_GET['product_id']> 0) {
  echo "<script> window.history.back() </script>";
    ...
    if ((int) $result['id'] < 100 && (int) $result['id'] > 10) {
      $prod_id = "0".$result['id'];
    } else if ((int) $result['id'] < 100 && (int) $result['id'] < 10 ) {
      $prod_id = "00".$result['id'];
    } else {
      $prod_id = $result['id'];
    }
?>
        ...
        <div class="container">
          <div class="row mb-5">
            ...
            <div class="col-lg-6">
              ...
              <p class="text-muted lead"><?php echo dollar.$result['product_new_price']; ?></p>
              <p class="text-sm mb-4"><?php echo $result['product_description']; ?></p>
              <div class="row align-items-stretch mb-4">
                
                <div class="col-sm-3 pl-sm-0"><a class="add-to-cart-<?php echo $result['id'];?> btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" onclick = "add_to_cart(<?php echo $result['id']; ?>)">Add to cart</a></div>
              </div>
              <ul class="list-unstyled small d-inline-block">
                <li class="px-3 py-2 mb-1 bg-white"><strong class="text-uppercase">SKU:</strong><span class="ms-2 text-muted"><?php echo $prod_id; ?></span></li>
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ms-2" href="#!"><?php echo $result['product_category']; ?></a></li>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                ...
                <p class="text-muted text-sm mb-0"><?php echo $result['product_description'] ?></p>
              </div>
            </div>
